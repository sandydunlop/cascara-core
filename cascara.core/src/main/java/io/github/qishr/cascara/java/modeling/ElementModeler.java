...
import io.github.qishr.cascara.java.model.AbstractMember;
...
import io.github.qishr.cascara.java.model.Deprecation;
...
import io.github.qishr.cascara.java.model.Link;
...
import io.github.qishr.cascara.java.model.SemanticNode;
import io.github.qishr.cascara.java.model.SourceCodeLocation;
import io.github.qishr.cascara.java.model.Text;
import io.github.qishr.cascara.java.model.TypeNode;
import io.github.qishr.cascara.java.model.VariableTypeNode;
import io.github.qishr.cascara.java.model.Text.Segment;
import io.github.qishr.cascara.java.modeling.MarkdownParser.TokenKind;
...
public class ElementModeler implements Modeler<ModuleElement, PackageElement, TypeElement, VariableElement, ExecutableElement, VariableElement> {
    ...
    public void setModifiers(AbstractMember node, Set<Modifier> modifiers) {
        for (Modifier modifier : modifiers) {
            io.github.qishr.cascara.java.model.Modifier mod =
                io.github.qishr.cascara.java.model.Modifier.valueOf(modifier.name());
    ...
    public void setDeprecationStatus(SemanticNode node, Element e, DocCommentTree dct) {
        if (node == null) return;
    ...
    public void setMethodAnnotations(MethodNode method, ExecutableElement methodElement) {
        for (AnnotationMirror anno : methodElement.getAnnotationMirrors()) {
            ...
            if ("Override".equals(typeElement.getSimpleName().toString())) {
                ...
                Reference reference = NameUtil.createReference("#" + method.getName().simpleName().toLowerCase());
            ...
            if (tagTree instanceof SeeTree seeTree) {
                ...
                for (DocTree docRef : see) {
                    if (docRef.getKind() == DocTree.Kind.MARKDOWN) {
                        ...
                        refs.add(Link.to(NameUtil.createReference(docRef.toString())).withKind(Link.Kind.TYPE));
                    }
                }
            }
        }
    ...
    private void setDocumentation(SemanticNode node, Element e) {
