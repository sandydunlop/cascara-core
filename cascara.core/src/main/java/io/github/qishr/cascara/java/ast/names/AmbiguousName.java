...
public class AmbiguousName extends ASTNode implements Identifiable, Name {
    ...
    // public AmbiguousName getAmbiguousName() {
    //     return ambiguousName;
    // }

    public void setAmbiguousName(AmbiguousName ambiguousName) {
