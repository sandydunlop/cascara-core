...
public class TypeNode extends AbstractMember {
    ...
    public boolean isClass() { return kind == SemanticNode.Kind.CLASS; }

    public boolean isInterface() { return kind == SemanticNode.Kind.INTERFACE; }

    public boolean isEnum() { return kind == SemanticNode.Kind.ENUM; }

    public boolean isRecord() { return kind == SemanticNode.Kind.RECORD; }

    public boolean isAnnotation() { return kind == SemanticNode.Kind.ANNOTATION; }
    ...
    public String getModifiersString() {
        ...
        for (Modifier mod : modifierList) {
            if ((kind != SemanticNode.Kind.ANNOTATION && kind != SemanticNode.Kind.INTERFACE) || mod != Modifier.ABSTRACT) {
